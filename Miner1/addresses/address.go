...
func PortInit() {
	...
	AddPort("0.0.0.0:8004")
	AddPort("0.0.0.0:8005")
	AddPort("0.0.0.0:8006")
	AddPort("0.0.0.0:8007")
	AddPort("0.0.0.0:8008")
	AddPort("0.0.0.0:8009")
	AddPort("0.0.0.0:8010")
}
...
func AlivePort() []string {
	...
	//打乱顺序，如果顺序一样则可能产生靠前位置结点已经广播了块，后面的结点还没选出胜者的情况
	//把自己放在最后一个。
